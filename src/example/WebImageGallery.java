...
public class WebImageGallery extends JComponent
{
    ...
    private final java.util.List<ImageIcon> images = new ArrayList<ImageIcon>();
    private final java.util.List<BufferedImage> reflections = new ArrayList<BufferedImage> ();
    ...
    {
        return getView ( StyleId.scrollpane );
    }
    ...
    private static void scrollSmoothly (@NotNull final JScrollPane scrollPane, int xValue, int yValue )
    {
        ...
        final Thread scroller = new Thread (() -> {
            ...
            while ( lastHorValue != x || lastVerValue != y )
            {
                ...
                if ( lastHorValue != x )
                {
                    ...
                    lastHorValue = value;
                    CoreSwingUtils.invokeLater (() -> hor.setValue ( value ));
                ...
                if ( lastVerValue != y )
                {
                    ...
                    lastVerValue = value;
                    CoreSwingUtils.invokeLater (() -> ver.setValue ( value ));
    ...
    private void moveReflection ()
    {
        ...
        progress = 0f;
        reflectionMover = new WebTimer ( "WebImageGallery.reflectionMoveTimer", SwingUtils.frameRateDelay ( 48 ), e -> {
            if ( progress < 1f )
            {
                progress += 0.08f;
